"""
Spatial Transcriptomics - Model Architecture
"""
import torch
...
class SpatialTranscriptomics(nn.Module):
    """
    Main model for spatial transcriptomics.
    """
...
def build_model(config):
    model = SpatialTranscriptomics(config)
